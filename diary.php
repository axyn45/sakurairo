...
<div id="primary" class="content-area">
    <main id="main" class="site-main" role="main">
        <div class="cbp_diary">
            <?php
            query_posts("post_type=diary & post_status=publish & posts_per_page=-1");
            if (have_posts()) : ?>
                <ul class="cbp_tmtimeline">
                    <?php
                    while (have_posts()) : the_post(); ?>
                        <li>
                            <span class="diary_author_img"><img src="<?php echo get_avatar_url(get_the_author_meta('ID')); ?>" class="avatar avatar-48" width="48" height="48"></span>
                            <a class="cbp_tmlabel" href="javascript:void(0)">
                                <p></p>
                                <p><?php the_content(); ?></p>
                                <p></p>
                                <p class="diary_time"><i class="fa fa-clock-o"></i> <?php the_time('Y年n月j日G:i'); ?></p>
                            </a>
                        </li>
                    <?php endwhile;
                    wp_reset_query();//重置查询
...
<script type="text/javascript">
    $(function() {
        ...
        $(".cbp_tmtimeline li").hover(function() {
            Obj = $(this).children(".diary_author_img");
